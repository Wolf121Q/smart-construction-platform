...
def live_unread_notification_list(request):
    ...
    for notification in request.user.notifications.unread()[0:num_to_fetch]:
        ...
        if notification.action_object.project:
            struct['project_ref'] = str(notification.action_object.project.id)
...
def live_all_notification_list(request):
    ...
    for notification in request.user.notifications.all()[0:num_to_fetch]:
        ...
        if notification.action_object:
            struct['action_object'] = str(notification.action_object)
            if notification.action_object.project:
                struct['project_ref'] = str(notification.action_object.project.reference_number)
