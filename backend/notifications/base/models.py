...
class AbstractNotification(models.Model):
    ...
    unread = models.BooleanField(default=True, blank=True, db_index=True)
    ...
    target_url = models.URLField(max_length=400,null=True,help_text="Enter the URL")

    action_object_content_type = models.ForeignKey(ContentType, blank=True, null=True,
                                                   related_name='notify_action_object', on_delete=models.CASCADE)
    action_object_object_id = models.UUIDField(default=uuid.uuid4, blank=True, null=True)
