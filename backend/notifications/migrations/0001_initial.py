    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unread', models.BooleanField(blank=True, db_index=True, default=True)),
                ('actor_object_id', models.CharField(max_length=255)),
                ('verb', models.CharField(max_length=255)),
                ('description', models.TextField(blank=True, null=True)),
                ('target_object_id', models.CharField(blank=True, max_length=255, null=True)),
                ('target_url', models.URLField(help_text='Enter the URL', max_length=400, null=True)),
                ('action_object_object_id', models.UUIDField(blank=True, default=uuid.uuid4, null=True)),
