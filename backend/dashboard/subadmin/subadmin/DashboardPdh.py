...
from organization.submodels.Region import Region
...
class DashboardPdhAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        region_data = list(project_qs.order_by('region__ordering').values(name = F('region__name')).distinct().annotate(y = Count('id')))
