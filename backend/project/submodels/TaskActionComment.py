...
class TaskActionCommentManager(models.Manager):
    def get_queryset(self):
        return super(TaskActionCommentManager, self).get_queryset().filter()

class TaskActionComment(models.Model):
    ...
    actual_quantity = models.DecimalField(default=0.0,max_digits = 8,decimal_places = 2,blank=True, null=True)
    damage_quantity = models.DecimalField(default=0.0,max_digits = 8,decimal_places = 2,blank=True, null=True)
    received_quantity = models.DecimalField(default=0.0,max_digits = 8,decimal_places = 2,blank=True, null=True)
    ...
    objects = TaskActionCommentManager()
    ...
    def save(self, *args, **kwargs):
        ...
        super(TaskActionComment, self).save(*args, **kwargs)
