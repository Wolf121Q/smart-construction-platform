...
class ProjectManager(BaseUserManager):
    def get_queryset(self):
        return super(ProjectManager, self).get_queryset().filter(region__status='active')
...
class Project(models.Model):
    ...
    description = models.TextField(verbose_name="Action Comments",null=True,blank=True)
    ...
    contractor = models.ForeignKey('vendor_company.VendorCompany',null=True,blank=True,verbose_name = "Contractor", on_delete=models.CASCADE, related_name="%(app_label)s_%(class)s_related",related_query_name="%(app_label)s_%(class)ss")
