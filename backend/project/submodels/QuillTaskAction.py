...
class QuillTasktActionManager(models.Manager):
    def get_queryset(self):
        return super(QuillTasktActionManager, self).get_queryset().filter()

class QuillTaskAction(models.Model):
