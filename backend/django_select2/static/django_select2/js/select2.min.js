    ...
    var e = function() {
            ...
            return e && e.requirejs || (e ? n = e : e = {}, m = {}, v = {}, y = {}, _ = {}, i = Object.prototype.hasOwnProperty, a = [].slice, w = /\.js$/, f = function(e, t) {
                ...
                return f.Extend(r, f.Observable), r.prototype.render = function() {
                    ...
                    if (null != e.results && 0 !== e.results.length) {
                        ...
                        for (var n = 0; n < e.results.length; n++) {
                            //console.log(e.results[n]);
                            var r = e.results[n],
                                i = this.option(r);
                                if(r.system_code)
                                {
                                    localStorage.setItem(r.id, r.system_code);
                                }
                            t.push(i)
                        }
                ...
                return n.Extend(i, t), i.prototype.render = function() {
                    ...
                    return e.addClass("select2-selection--single"), e.html('<span class="select2-selection__rendered form-control form-control-lg"></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>'), e
